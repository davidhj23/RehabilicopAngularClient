...
export class EquiposComponent implements OnInit {   
    ...
    private loadAllEquipos() {     
        this.showLoading(true);   
        this.equipoService.getAll()
            .subscribe(
                equipos => { 
                    this.equipos = equipos; 
                    this.temp = this.equipos;
    ...
    create() {
        ...
        this.showLoading(true);    
        this.equipoService.create(this.model)
            .subscribe(
                data => {                        
                    this.clearModel();
                    this.loadAllEquipos();
    ...
    edit(model: any, editContent: any) {            
        this.modelToEdit.idEquipo = model.idEquipo;     
        ...
        this.ngbModal.open(editContent).result.then((result) => {
            ...
            if(this.validateEdit()){                                               
                this.equipoService.update(this.modelToEdit)
                    .subscribe(
                        data => {
                            this.clearModel();
                            this.loadAllEquipos();
    ...
    delete(idEquipo: string, content: any) {   
        this.clearAndcloseErrors();   
