...
export class DosisComponent implements OnInit {   
    ...
    private loadAllDosis() {     
        this.showLoading(true);   
        this.dosisService.getAll()
            .subscribe(
                dosis => { 
                    this.dosis = dosis; 
                    this.temp = this.dosis;
    ...
    create() {
        ...
        this.showLoading(true);    
        this.dosisService.create(this.model)
            .subscribe(
                data => {                        
                    this.clearModel();
                    this.loadAllDosis();
    ...
    edit(model: any, editContent: any) {            
        this.modelToEdit.idDosis = model.idDosis;     
        ...
        this.ngbModal.open(editContent).result.then((result) => {
            ...
            if(this.validateEdit()){                                               
                this.dosisService.update(this.modelToEdit)
                    .subscribe(
                        data => {
                            this.clearModel();
                            this.loadAllDosis();
    ...
    delete(idDosis: string, content: any) {   
        this.clearAndcloseErrors();   
        this.ngbModal.open(content).result.then((result) => {
            this.showLoading(true);
            this.dosisService.delete(idDosis)
                .subscribe(data => {                    
                    this.loadAllDosis();                    
                    this.showLoading(false);
                }, error => {       
