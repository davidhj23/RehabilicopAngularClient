...
export class EstadosComponent implements OnInit {   
    ...
    private loadAllEstados() {     
        this.showLoading(true);   
        this.estadoService.getAll()
            .subscribe(
                estados => { 
                    this.estados = estados; 
                    this.temp = this.estados;
    ...
    create() {
        ...
        this.showLoading(true);    
        this.estadoService.create(this.model)
            .subscribe(
                data => {                        
                    this.clearModel();
                    this.loadAllEstados();
    ...
    edit(model: any, editContent: any) {            
        this.modelToEdit.idEstado = model.idEstado;     
        ...
        this.ngbModal.open(editContent).result.then((result) => {
            ...
            if(this.validateEdit()){                                               
                this.estadoService.update(this.modelToEdit)
                    .subscribe(
                        data => {
                            this.clearModel();
                            this.loadAllEstados();
    ...
    delete(idEstado: string, content: any) {   
        this.clearAndcloseErrors();   
        this.ngbModal.open(content).result.then((result) => {
            this.showLoading(true);
            this.estadoService.delete(idEstado)
                .subscribe(data => {                    
                    this.loadAllEstados();                    
                    this.showLoading(false);
                }, error => {       
