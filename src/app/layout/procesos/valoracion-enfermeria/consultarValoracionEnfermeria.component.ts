...
@Component({
    selector: 'consultarValoracionEnfermeria',
    templateUrl: 'consultarValoracionEnfermeria.component.html',
})

export class ConsultarValoracionEnfermeriaComponent implements OnInit {       
    ...
    ver(model: any) {            
        this.router.navigate(['/layout/procesos/historias/ver-valoracion-enfermeria', model.idHistoria]);
    }
